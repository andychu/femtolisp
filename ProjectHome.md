## This project has [moved to github](http://github.com/JeffBezanson/femtolisp). ##

**Also check out my current project, [Julia](http://github.com/JuliaLang/julia), a very fast dynamically-typed language. Julia's compiler front end uses femtolisp.**
